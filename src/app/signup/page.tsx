...
export default function SignUp() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      else setMsg("Sign-up successful. Check your email if confirmations are enabled.");
  ...
  return (
    <div className="max-w-sm mx-auto space-y-3">
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        ...
        <input className="w-full border rounded px-3 py-2" type="password" placeholder="Create a password"
